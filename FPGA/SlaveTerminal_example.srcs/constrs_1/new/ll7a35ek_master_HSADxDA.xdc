...
create_clock -period 10.000 -name sys_clk_in_pin -add [get_ports clk_in];
#my clk
#create_clock -period 10.000 -name sys_clk_pin -add [get_ports clk];
#create_clock -period 5.000 -name sys_clk_200M_pin -add [get_ports clk_200M];
create_clock -period 10.0 [get_ports clk]
set_input_jitter [get_clocks -of_objects [get_ports clk]] 0.1
create_clock -period 5.0 [get_ports clk_200M]
set_input_jitter [get_clocks -of_objects [get_ports clk_200M]] 0.1
...
#set_property PACKAGE_PIN C6  [get_ports MOSI_DA];  # n
#set_property PACKAGE_PIN C7  [get_ports CS_DA];  # p
...
# P3
set_property PACKAGE_PIN B7  [get_ports ExtTri];  # p
#set_property PACKAGE_PIN A7  [get_ports ExtTri];  # n
#set_property PACKAGE_PIN B6  [get_ports p302];  # p
#set_property PACKAGE_PIN B5  [get_ports SquareOut];  # n
set_property PACKAGE_PIN A5  [get_ports SquareTick];  # p
set_property PACKAGE_PIN A4  [get_ports SquareOut];  # n
